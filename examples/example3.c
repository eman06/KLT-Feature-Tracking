...
img2 = (unsigned char *) malloc(ncols*nrows*sizeof(unsigned char));
  ...
  KLTWriteFeatureListToPPM(fl, img1, ncols, nrows, "data/feat0.ppm");
  ...
  for (i = 1 ; i < nFrames ; i++)  {
    ...
    sprintf(fnameout, "data/feat%d.ppm", i);
    KLTWriteFeatureListToPPM(fl, img2, ncols, nrows, fnameout);
  }
  KLTWriteFeatureTable(ft, "data/features.txt", "%5.1f");
  KLTWriteFeatureTable(ft, "data/features.ft", NULL);
